        ...
        <table class="table table-striped b-t b-light">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a href="{{URL::to('/view-order/'.$order->order_id)}}" class="editPro" ui-toggle-class="">
                  <i class="fa fa-pencil-square text-success text-active"></i> </a>
                  <br>
                <a onclick="return confirm('Are you sure to delete?')" href="{{URL::to('/delete-order/'.$order->order_id)}}" class="delPro" ui-toggle-class="">
